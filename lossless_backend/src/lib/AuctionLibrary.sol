...
library AuctionLibrary {
    ...
    function goLive(uint _auctionId, AppLibrary.Layout storage layout) external {
        ...
        AppLibrary.addToLiveArray(ad, layout);
    }

    function endLive(uint _auctionId, AppLibrary.Layout storage layout) external {
        ...
        AppLibrary.removeFromLiveArray(_auctionId, layout);
    ...
    function getAllLive(AppLibrary.Layout storage layout) external view returns (AuctionDetails[] memory){
        return layout.liveAuctionsArray;
    }
